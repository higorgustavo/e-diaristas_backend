...
def calcular_indice_compatibilidade(diaria_id, diarista_id):
    ...
    distancia_diarista_diaria = calcular_distancia_diaria_diarista(
                                diaria.cep, endereco_diarista.cep)
...
def calcular_distancia_diaria_diarista(cep_diaria, cep_diarista):
    ...
    distancia = gmaps.distance_matrix(
                    cep_formatado_diaria, cep_formatado_diarista)['rows'][0]['elements'][0]
