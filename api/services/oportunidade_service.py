...
def listar_oportunidades(diarista_id):
    ...
    oportunidades_cidades = Diaria.diaria_objects.oportunidades_cidade(cidades_atendidas_usuario)\
        .filter(numero_diaristas__lt=3).exclude(candidatas=diarista_id)
